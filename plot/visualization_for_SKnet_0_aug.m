...
[i2 trainl2 traina2 testl2 testa2] = readCSV('sknetaug.csv');
...
grid minor
title('loss')
legend('origin train','origin test','augmented train','augmented test','Location','southwest')
xlabel('epoch')
ylabel('loss')
...
grid minor
title('SKNet test accuracy comparison')
legend('origin data', 'augmented data','75% line', 'Location','southeast')
xlabel('epoch')
ylabel('accuracy')
xlim([0, 30])
ylim([20, 100])
